...
// TemplateLiteral represents template literals like `Hello ${name}`
type TemplateLiteral struct {
	Token       token.Token  // the backtick token
	Parts       []string     // static text parts
	Expressions []Expression // expressions to interpolate
}
...
// HashLiteral represents hash literals like {"key": "value"}
