...
// RegexBuiltins contains all regex-related built-in functions
var RegexBuiltins = map[string]*object.Builtin{
	"regex": {
		Fn: func(args ...object.Object) object.Object {
			...
			// Return a hash representing the regex
...
// applyRegexFlags applies JavaScript-style flags to regex patterns
...
// nativeBoolToRegexObject converts native Go bool to Jabline boolean object
...
// InitRegexBuiltins initializes regex built-ins in the global builtins map
