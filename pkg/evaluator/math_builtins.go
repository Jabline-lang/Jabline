...
// MathBuiltins contains all advanced math-related built-in functions
	...
	"random": {
		Fn: func(args ...object.Object) object.Object {
			...
			if len(args) == 1 {
				...
				// Simple pseudo-random using math functions
...
// InitMathBuiltins initializes math built-ins in the global builtins map
